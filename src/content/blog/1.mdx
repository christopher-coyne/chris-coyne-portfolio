...
<h2 class="font-bold text-2xl md:text-3xl">The Game</h2>
...
<h2 class="font-bold text-3xl">Images and Artifical Intelligence</h2>
...
<Section class="flex flex-col gap-8">
<h2 class="font-bold text-3xl">The Implications</h2>
