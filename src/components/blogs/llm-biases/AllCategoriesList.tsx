...
const AllCategoriesList: React.FC<AllCategoriesListProps> = ({ data }) => {
  ...
  return (
    <div className="p-4 border border-red-300 rounded-md relative">
      <h2 className="text-2xl font-bold mb-2">All Project Ideas</h2>
      <p className="text-sm text-base-content/70 mb-4">
        All project ideas generated by Gemini 2.5 Flash
      </p>
